...
<form id="imageboardListForm" method="post" action="/springminiProject/imageboard/imageboardDelete">
<table id="imageboardTable" border="1" frame="hsides" rules="rows" cellspacing="0" cellpadding="3">
<tr>
...
<div id="imageboardPagingDiv" style="float: left; width: 650px; text-align: center;">
...
$(document).ready(function(){
	$.ajax({
		type: 'post',
		url: '/springminiProject/imageboard/getImageboardList',
		data: 'pg=${pg}',
		dataType: 'json',
		success: function(data){
			...
			$.each(data.list, function(index, items){
				...
				$('.'+items.seq).click(function(){
					location.href = '/springminiProject/imageboard/imageboardView?seq='+items.seq+'&pg=${pg}';     
				});
			});

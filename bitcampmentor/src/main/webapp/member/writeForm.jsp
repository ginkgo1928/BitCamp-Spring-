	...
	<div class="page-content">
		<div class="content-wrapper">
			...
			<div class="block inset login-block">
				...
				<input type="hidden" name="member_flag">
					...
					<div class="list form-list no-hairlines no-margin-top">
						<ul>
								...
								<div class="item-inner">
									<div class="item-input-wrap">
										<input autocomplete="name"
											class="string required" placeholder="이름" type="text"
											name="member_name" id="member_name" value=""
											 onkeyup="Ifn_NameCheck();" />
								...
								<div class="item-inner">
									<div class="item-input-wrap">
										<input autocapitalize="off" autocorrect="off"
											...
											id="member_email"  maxlength="50"  onkeypress="Ifn_EmailCheck();" />
							...
							<li class="item-content item-input">
								<div class="item-inner">
									<div class="item-input-wrap">
										<input required="required"class="password" placeholder="비밀번호 확인" type="password"
											name="member_repwd" id="member_repwd" onkeyup="Ifn_RepwdCheck();" />
					...
					<div class="block-footer term-footer">
						...
						및 <a href=""type="external" target="_blank">개인정보처리방침</a>에 동의하는 것으로 간주합니다.
						<div>
					</div>
					</div>

					<input type="button" id="commitBtn" value="회원가입" class="btn button button-big button-fill" data-disable-with="요청중..." />
				</form>
			</div>


			<div class="block inset text-align-center">
				<a class="color-gray" type="external" href=""> 이미 계정이 있나요? 로그인 </a>
			</div>
		</div>
	</div>
</div>
